...
def galaxy_crossmatch(gal1, gal1_catalog_name, cache):
    """See if gal1 is already in the cache.
    
    Args:
        gal1: The galaxy to be crossmatched.
        gal1_catalog_name: The name of the catalog in gal1.
    ...
    first_star = gal1[first_star][gal1_catalog_name]

    first_star_coord = {"RAJ2000": first_star["RAJ2000"],
                        "DEJ2000": first_star["DEJ2000"]}
    gal_name, _ = find_nearest_galaxy(first_star_coord, cache, gal1_catalog_name)
